          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-3">
                Select which AI provider to use for document generation. All
                providers are supported but only the active one will be used.
              </p>
            ...
            <div className="bg-accent bg-opacity-10 p-3 rounded-lg border border-accent">
              ...
              <p className="text-xs text-muted-foreground">
                API keys are managed via environment variables or the Vercel AI
                Gateway. Configure your API keys in your project settings.
              </p>
            </div>
            ...
            <div className="bg-muted bg-opacity-50 p-3 rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                All providers have access to the same document generation
                pipeline. Switch providers anytime to compare results or handle
                provider outages.
              </p>
            </div>
            ...
            <div className="border-t border-border pt-4 mt-4">
              ...
              <p className="text-xs text-muted-foreground">
                For additional settings like custom templates, skill management,
                and memory configuration, navigate to the respective tabs in the
                dashboard.
              </p>
            </div>
          </div>
